...
export default function DoctorProfile() {
  const credentials = [
    { icon: 'school', title: 'Pendidikan', desc: 'Lulusan Kedokteran Gigi Universitas terkemuka dengan predikat cumlaude' },
    { icon: 'workspace_premium', title: 'Sertifikasi', desc: 'Anggota Persatuan Dokter Gigi Indonesia (PDGI) & Bersertifikasi Estetik' },
    { icon: 'psychology', title: 'Keahlian Khusus', desc: 'Spesialis Restorasi Estetik Gigi, Bleaching, Scaling, & Konsultasi Preventif' }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative w-full aspect-[4/5] rounded-2xl overflow-hidden ambient-shadow max-w-md mx-auto">
            <img 
              alt="drg. Lely Apriani Nasution profile portrait" 
              className="w-full h-full object-cover transition-transform duration-700 hover:scale-105"
              src="/fotodokter.png"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-primary/80 via-transparent to-transparent"></div>
            <div className="absolute bottom-6 left-6 text-white text-left">
              <h4 className="font-serif text-lg font-bold">drg. Lely Apriani Nasution</h4>
              <p className="font-sans text-xs text-secondary-fixed">Dokter Gigi Utama</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 text-left space-y-6">
            ...
            <p className="font-sans text-sm md:text-base text-on-surface-variant leading-relaxed">
              Drg. Lely Apriani Nasution adalah dokter gigi penanggung jawab di LA Dental Care Klampok. Beliau berkomitmen untuk memberikan pelayanan dental yang penuh perhatian, informatif, dan disesuaikan dengan kebutuhan unik setiap pasien. Dengan pendekatan klinis yang modern dan ramah, beliau memastikan setiap prosedur berlangsung dengan aman dan minim kecemasan.
            </p>
